 ...
 */
//аннотацией entities помечаются классы,которые будут хранится в бд
...
abstract class SportDb : RoomDatabase() {
    ...
    //статика для потокобезопасного создания и возврата инстанса SportDb
    companion object {
        ...
        fun getDatabase(context: Context): SportDb {
            return INSTANCE ?: synchronized(this) {
                Room.databaseBuilder(context.applicationContext, SportDb::class.java, "sport_db")
                    //автоматическое воссоздание бд в случае повреждения
