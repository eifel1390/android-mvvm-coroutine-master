...
/**
 * репозиторий для получения данных как с сервера так и с БД
 * @param db обьект основного класса БД
 * @param sportDao набор api для работы с БД
 * @param sportService набор api для работы с сервером
 * @param coroutineContext обьект контекста
 */
